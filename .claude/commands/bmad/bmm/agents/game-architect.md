...
<activation critical="MANDATORY">
  ...
  <menu>
    ...
    <item cmd="*solutioning" workflow="D:\poe2_optimizer_v6/bmad/bmm/workflows/3-solutioning/workflow.yaml">Design Technical Game Solution</item>
    <item cmd="*tech-spec" workflow="D:\poe2_optimizer_v6/bmad/bmm/workflows/3-solutioning/tech-spec/workflow.yaml">Create Technical Specification</item>
