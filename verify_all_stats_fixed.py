...
print(f"Fire Resist:  {stats.resistances.get('fire', 'N/A')}% (expected: -50%)")
print(f"Cold Resist:  {stats.resistances.get('cold', 'N/A')}% (expected: -50%)")
print(f"Lightning:    {stats.resistances.get('lightning', 'N/A')}% (expected: -50%)")
...
checks = {
    ...
    "Fire Resist": abs(stats.resistances.get('fire', 0) - (-50)) <= 0.1,
    "Cold Resist": abs(stats.resistances.get('cold', 0) - (-50)) <= 0.1,
    "Lightning Resist": abs(stats.resistances.get('lightning', 0) - (-50)) <= 0.1,
