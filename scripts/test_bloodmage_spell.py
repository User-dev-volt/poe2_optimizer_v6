"""
Test bloodmage_remnants_95 spell build - has actual damaging spells
"""
...
def test_bloodmage_spell():
    """Test bloodmage build with actual damaging spells"""
    ...
    for i, skill in enumerate(build_data.skills, 1):
        ...
        print(f"  {i}. {skill.name:25} [{status}]  skill_id={skill.skill_id}")

    # Calculate with hybrid routing
    print("\n=== Calculating Build ===")
    print("(Check debug output for spell detection and base damage messages)")
